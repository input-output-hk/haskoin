...
toJsonAddr :: WalletAddr -> Maybe BalanceInfo -> JsonAddr
toJsonAddr addr balM =
    JsonAddr
...
toJsonTx acc bbM tx =
    ...
    , jsonTxValue =
        fromIntegral (walletTxInValue tx) - fromIntegral (walletTxOutValue tx)
...
toJsonCoin
    ...
    -> JsonCoin
toJsonCoin coin txM addrM spendM =
    JsonCoin
